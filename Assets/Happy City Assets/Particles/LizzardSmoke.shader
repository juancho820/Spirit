...
/////// Diffuse:
                ...
                float4 node_9580 = _Time;
                float node_6763_ang = node_9580.g;
                ...
                float3 node_3972 = (_Lizzard3_var.rgb*_Lizzard2_var.rgb*_Lizzard1_var.rgb);
                float3 diffuseColor = (_Colorcito.rgb*i.vertexColor.rgb*i.vertexColor.a*node_3972);
                float3 diffuse = (directDiffuse + indirectDiffuse) * diffuseColor;
/// Final Color:
                float3 finalColor = diffuse;
                fixed4 finalRGBA = fixed4(finalColor,(node_3972.r*i.vertexColor.a*lerp(_Blanco.rgb,_negro.rgb,length((i.uv0*2.0+-1.0)).r).r));
...
/////// Diffuse:
                ...
                float4 _Lizzard3_var = tex2D(_Lizzard3,TRANSFORM_TEX(node_9656, _Lizzard3));
                float4 node_4713 = _Time;
                float4 node_3560 = _Time;
                float node_6763_ang = node_3560.g;
                float node_6763_spd = 1.0;
                float node_6763_cos = cos(node_6763_spd*node_6763_ang);
                float node_6763_sin = sin(node_6763_spd*node_6763_ang);
                float2 node_6763_piv = float2(0.5,0.5);
...
/// Final Color:
                float3 finalColor = diffuse;
                fixed4 finalRGBA = fixed4(finalColor * (node_3972.r*i.vertexColor.a*lerp(_Blanco.rgb,_negro.rgb,length((i.uv0*2.0+-1.0)).r).r),0);
                UNITY_APPLY_FOG(i.fogCoord, finalRGBA);
                return finalRGBA;
            }
            ENDCG
